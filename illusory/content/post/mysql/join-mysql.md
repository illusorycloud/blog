---
title: "MySQL 中 JOIN 语句有什么不同"
description: "MySQL 中的 JOIN 语句实现"
...
本文主要记录了 JOIN 语句 在 MySQL 中的差异。

<!--more-->

## 1. 概述

虽然存在 SQL92 or SQL99 等等 SQL 标准。但是 SQL 标准只是限制了结果，却没有限制如何实现。

所以在 MySQL 中的 JOIN 语句也是和其他的有一定差距的。
